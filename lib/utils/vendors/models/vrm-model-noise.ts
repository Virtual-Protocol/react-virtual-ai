  ...
  update(deltaTime: number, reset?: boolean) {
    ...
    if (this.xmax !== this.xmin)
      this.x = MathUtils.lerp(
        this.x,
        MathUtils.randFloat(this.xmin, this.xmax),
        deltaTime
      );
    if (this.ymax !== this.ymin)
      this.y = MathUtils.lerp(
        this.y,
        MathUtils.randFloat(this.ymin, this.ymax),
        deltaTime
      );
    if (this.zmax !== this.zmin)
      this.z = MathUtils.lerp(
        this.z,
        MathUtils.randFloat(this.zmin, this.zmax),
        deltaTime
      );
    this.bone.quaternion.multiply(
      tempQ.setFromEuler(tempEular.set(this.x, this.y, this.z))
    );
    this.firstRun = false;
  }
}
