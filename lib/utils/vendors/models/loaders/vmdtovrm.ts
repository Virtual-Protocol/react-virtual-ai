...
import { AnimationData, Timeline, VRMOffsets } from "./vmdtovrmbinding";
import { isTruely } from "../../helper-functions";
...
const IK_OFFSET_INIT = new Map<VMDBoneNames, IKOffsetInit>([
  ...
  [
    ...
    { x: 0, y: -1, z: -1, s: 10, oy: 2.5, dx: true, dz: true },
  ],
  [
...
// WorkerMessageService.host.on(module.exports);
