...
export class LipSync {
  ...
  startWithAudio(audio, audioContext, onAudioStart, onAudioEnd) {
  ...
  startFromAudioBuffer(buffer) {
    ...
    // Play sound
    if (this.mediaStreamSource.start) {
      this.mediaStreamSource.start(0);
    } else if (this.mediaStreamSource.play) {
      this.mediaStreamSource.play(0);
    } else if (this.mediaStreamSource.noteOn) {
      this.mediaStreamSource.noteOn(0);
    }
