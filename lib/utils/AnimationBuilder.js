// https://github.com/JLChnToZ/vrm-dance-viewer/blob/master/src/worker/vrm-model-noise.ts
...
import { blendshape_map_by_MMD_name_VRM1, boneMap } from "./boneMaps";
  ...
  buildSkeletalAnimation(vmd, bones, vrm) {
    ...
    for (let i = 0; i < vmd.metadata.motionCount; i++) {
      ...
      if (!Object.keys(boneMap).includes(boneName)) {
        console.log("boneName not found", boneName);
        continue;
      }
